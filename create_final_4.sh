...
# Create 4 remaining comprehensive cheatsheets

# Cheatsheet 7: Gradient Boosting Hyperparameters
cat > cheatsheets/gradient_boosting_hyperparameters_cheatsheet.html << 'EOF'
<!DOCTYPE html>
<html lang="ru">
<head>
  <meta charset="UTF-8">
...
echo "Created gradient_boosting_hyperparameters_cheatsheet.html"
