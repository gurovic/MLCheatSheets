# Добавить matplotlib-иллюстрации: Computer Vision

**Заголовок issue:** `Добавить matplotlib-иллюстрации: Computer Vision`

---

## 📊 Добавление иллюстраций для раздела "Computer Vision"

### Описание
Необходимо добавить matplotlib-иллюстрации (графики, схемы, диаграммы) в cheatsheets раздела "Computer Vision" для улучшения визуального представления материала и облегчения понимания концепций.

### Страницы раздела (8)
- [ ] `object_detection_cheatsheet.html` - Object Detection
- [ ] `yolo_cheatsheet.html` - Yolo
- [ ] `image_segmentation_cheatsheet.html` - Image Segmentation
- [ ] `keypoint_detection_pose_estimation_cheatsheet.html` - Keypoint Detection Pose Estimation
- [ ] `cnn_visualization_techniques_cheatsheet.html` - Cnn Visualization Techniques
- [ ] `grad_cam_cheatsheet.html` - Grad Cam
- [ ] `saliency_maps_cheatsheet.html` - Saliency Maps
- [ ] `neural_style_transfer_cheatsheet.html` - Neural Style Transfer
